                                    ...
                                    <tr key={officer.id} className="hover:bg-slate-50 transition-colors">
                                        <td className="py-3 px-4">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <div className="font-semibold text-slate-800">{officer.name}</div>
                                                    <div className="text-xs text-slate-400 font-mono">{officer.id}</div>
                                                </div>
                                            </div>
                                        </td>
                                        <td className="py-3 px-4 text-slate-600 font-medium">{officer.lga}</td>
                                        <td className="py-3 px-4">
                                            <span className={cn("px-2 py-1 rounded-full text-xs font-medium border", 
                                                officer.status === 'Active' ? "bg-emerald-50 text-emerald-700 border-emerald-100" :
                                                officer.status === 'Offline' ? "bg-slate-100 text-slate-600 border-slate-200" :
                                        ...
                                        <td className="py-3 px-4">
                                            <div className="flex items-center gap-2">
                                                <span className="font-bold text-slate-700">{officer.verifications}</span>
                                                <span className="text-xs text-slate-400">records</span>
                                            </div>
                                        </td>
                                        <td className="py-3 px-4 text-slate-500 flex items-center gap-2">
                                            <div className={cn("w-1.5 h-1.5 rounded-full",
                                                 officer.lastActive.includes('mins') || officer.lastActive.includes('Just') ? "bg-emerald-500" : "bg-slate-300"
                                            )}/>
                                            {officer.lastActive}
                                        </td>
                                        <td className="py-3 px-4">
